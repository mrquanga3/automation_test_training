...
public class ResultBT2 {
	...
	String name = browser.findElement(By.xpath("//li[@class='nav-item work']//a[@class='btn-log login-portal']")).getText();
	Assert.assertEquals("ĐĂNG NHẬP", name);
    }
	...
	browser.findElement(By.xpath("//div[@id='login_popup_id']//a[2]")).click();
	Assert.assertEquals("SAURIENGJ6",browser.findElement(By.xpath("//*[@id=\"btn-user-name-desktop\"]")).getText());
