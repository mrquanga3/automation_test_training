...
public class TestLoginFail extends BeforeTestCase {
	@Test
	public void Verify() throws IOException {
		XSSFSheet sh1 = ExcelOperationUsingPOI.getSheet();
		String getacc = sh1.getRow(2).getCell(0).getStringCellValue();
		...
		String getpass = sh1.getRow(2).getCell(1).getStringCellValue();
