...
public class BasePage {
	...
	public String login() {
		...
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		try {
			this.takeSnapShot(driver, "E://login.png");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		txtEmail = wait.until(ExpectedConditions.elementToBeClickable(txtEmail));

		txtEmail.sendKeys("tungthse02891@gmail.com");
		nextAcc.click();
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		wait.until(ExpectedConditions.visibilityOf(txtEmail));
		txtPass.sendKeys("DarkLord.123");
		nextPass.click();
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public void loginToPage(String strEmail, String strPassword) {
		...
		buttonGoogle.click();
		// Set email
		waitForElementVisible(30, txtEmail);
		txtEmail.sendKeys(strEmail);
		btnNext.click();
		// Set pass
		waitForElementVisible(30, txtPass);
