...
public class TestSelectionAdress extends TestTemplate {
	@DataProvider
	public Object[][] dataProviderMethod() {
		return new Object[][] { { "Chọn tất cả" }, { "Hà Nội" }, { "Thành phố Hồ Chí Minh" }, { "An Giang" },
				...
				{ "Lai Châu" }, { "Lầm Đồng" }, { "Lạng Sơn" }, { "Lào Cai" }, { "Long An" }, { "Nam Định" },
				{ "Nghệ An" }, { "Ninh Bình" }, { "Ninh Thuận" }, { "Phú Thọ" }, { "Phú yên" }, { "Quảng Bình" },
				{ "Quảng Nam" }, { "Quảng Ngãi" }, { "Quảng Ninh" }, { "Quảng Trị" }, { "Sóc Trăng" }, { "Sơn La" },
				{ "Tây Ninh" }, { "Thái Bình" }, { "Thái Nguyên" }, { "Thanh Hóa" }, { "Thừa Thiên - Huế" },
				{ "Tiền Giang" }, { "Trà Vinh" }, { "Tuyên Quang" }, { "Vĩnh Long" }, { "Vinh Phúc" },
				{ "Yên Bái" }, { "Nước ngoài" }};
	}
	@Test(dataProvider = "dataProviderMethod")
	public void testAdress(String Adress) {
