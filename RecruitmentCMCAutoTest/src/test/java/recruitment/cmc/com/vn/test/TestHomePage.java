...
public class TestHomePage extends TestTemplate {
	...
	public void testTitle(Method method) {
		HomePage homePage = new HomePage(drivers.get(TestTemplate.buildKeyForMappingDriverToTestMethod(method, new Object[] {})));
	...
	public void verifyLikeFunction(String sLogin, String sLike, Method method) throws Exception {
		HomePage homePage = new HomePage(
				drivers.get(TestTemplate.buildKeyForMappingDriverToTestMethod(method, new Object[] { sLogin, sLike })));
	...
	public void testLogin(Method method) {
		HomePage tlg = new HomePage(drivers.get(TestTemplate.buildKeyForMappingDriverToTestMethod(method, new Object[] {})));
		assertEquals(tlg.login(), "TUNGTHSE02891");
	}

	@Test(priority = 2)
	public void testLogOut(Method method) {
		HomePage tlgOut = new HomePage(drivers.get(TestTemplate.buildKeyForMappingDriverToTestMethod(method, new Object[] {})));
		tlgOut.login();
